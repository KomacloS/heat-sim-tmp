...
def plot_ring(
    ...
    The 1D radial solution is rotated around θ ∈ [0, 2π] to produce a
    “donut-shaped” pcolormesh.

    Args:
        r_centres: 1D array of radial cell centres.
        temperature: 1D array of temperatures corresponding to ``r_centres``.
    ...
    Z = np.tile(temperature[:, None], (1, n_theta))
